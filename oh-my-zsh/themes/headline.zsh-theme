...
HEADLINE_STYLE_BRANCH=$bold$light_green
...
HEADLINE_STYLE_USER_LINE=$red
HEADLINE_STYLE_HOST_LINE=$yellow
HEADLINE_STYLE_PATH_LINE=$blue
HEADLINE_STYLE_BRANCH_LINE=$light_green
HEADLINE_STYLE_STATUS_LINE=$magenta
